  ...
  <div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title">Form Kredit Pemilikan Rumah (KPR)</h4>

        <form class="forms-sample" method="POST" action="{{ route('simpan-kpr') }}">
          {{ @csrf_field() }}
          <div class="form-group">
            <label for="tipe_rumah">Tipe Rumah</label>
            <select class="form-control border-primary" id="tipe_rumah" name="tipe_rumah">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="alamat_rumah" name="alamat_rumah" placeholder="Alamat Rumah">
          </div>
          <div class="form-group">
