  ...
  <div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title">Form Kredit Kendaraan</h4>

        <form class="forms-sample" method="POST" action="{{ route('simpan-kendaraan') }}">
          {{ @csrf_field() }}
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="merk_kendaraan" name="merk_kendaraan" placeholder="Merk Kendaraan">
          </div>
          <div class="form-group">
