  ...
  <div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title">Form Kredit Tanpa Agunan (KTA)</h4>

        <form class="forms-sample" method="POST" action="{{ route('simpan-kta') }}">
          {{ @csrf_field() }}
          <div class="form-group">
            <label for="tujuan_penggunaan">Tujuan Penggunaan</label>
            <input type="text" class="form-control" id="tujuan_penggunaan" name="tujuan_penggunaan" placeholder="Tujuan Penggunaan">
          </div>
          <div class="form-group">
