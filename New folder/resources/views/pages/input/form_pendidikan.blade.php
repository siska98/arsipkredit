  ...
  <div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title">Form Kredit Pendidikan</h4>

        <form class="forms-sample" method="POST" action="{{ route('simpan-pendidikan') }}">
          {{ @csrf_field() }}
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="institusi_pendidikan" name="institusi_pendidikan" placeholder="Institusi Pendidikan">
          </div>
          <div class="form-group">
