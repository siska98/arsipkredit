<nav class="sidebar sidebar-offcanvas dynamic-active-class-disabled" id="sidebar">
  ...
  <li class="nav-item nav-profile not-navigation-link">
      <div class="nav-link">
      <img src="{{ url('images/bank.svg') }}" 
    style= "height: 180px;" alt="logo" /> </a>
      </div>
    </li>
    ...
    <li class="nav-item {{ active_class(['basic-ui/*']) }}">
      ...
      <div class="collapse {{ show_class(['basic-ui/*']) }}" id="basic-ui">
        ...
        <li class="nav-item {{ active_class(['/pinjaman']) }}">
            <a class="nav-link" href="{{ route('pinjaman.index') }}">
              <i class="mdi mdi-progress-clock"></i>
              Masih Berjalan
            </a>
          </li>
          <li class="nav-item {{ active_class(['pinjaman.selesai']) }}">
            <a class="nav-link" href="{{ route('pinjaman.selesai') }}">
